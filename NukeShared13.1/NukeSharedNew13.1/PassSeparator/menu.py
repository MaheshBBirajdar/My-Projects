...
class passSepPanel(nukescripts.panels.PythonPanel):
    ...
    def __init__(self, name):
        super(passSepPanel, self).__init__(name)
        ...
        self.btn01 = nuke.PyScript_Knob("btn01", "Shuffle Only", "separateChannels(\"N\", \"N\")")
        self.addKnob(self.btn01)

        # btn02 = NA COMPLETE
        self.btn02 = nuke.PyScript_Knob("btn02", "Complete", "separateChannels(\"N\", \"Y\")")
        ...
        self.btn03 = nuke.PyScript_Knob("btn03", "Shuffle Only", "separateChannels(\"Y\", \"N\")")
        self.addKnob(self.btn03)

        # btn04 = A COMPLETE
        self.btn04 = nuke.PyScript_Knob("btn04", "Complete", "separateChannels(\"Y\", \"Y\")")
...
nodesToolbar = nuke.menu('Nodes')
pass_separator_menu = nodesToolbar.addMenu('Pass Separator', icon='Pass_Sep.png')
pass_separator_menu.addCommand('Separate Channels', "callPassSep()", '^+a')
