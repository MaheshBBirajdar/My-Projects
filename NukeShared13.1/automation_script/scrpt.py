...
for i in range(rc) :
    ...
    given_exr_files_path = given_exr_files_path + "/"
    given_scope_of_work = cl[1]
    given_output_file_path_4k = cl[2]
    given_output_file_path_4k = given_output_file_path_4k + "/"
    given_output_file_path_hd = cl[3]
    given_output_file_path_hd = given_output_file_path_hd + "/"
    given_file_path_nk = cl[4]
    given_file_path_nk = given_file_path_nk+"/"
    give_files_name = cl[5]
    ...
    temp1 = given_output_file_path_4k + give_files_name
    output_file_path_4k = temp1

    temp2 = given_output_file_path_hd+give_files_name
    output_file_path_hd = temp2

    nk_nk = give_files_name.split(".")[0]
    nk_nk = nk_nk+ ".nk"
    temp3 = given_file_path_nk+nk_nk
    output_file_path_nk = temp3
