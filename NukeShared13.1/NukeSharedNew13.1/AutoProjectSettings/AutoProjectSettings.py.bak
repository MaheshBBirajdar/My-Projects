...
def AutoProjectSettings():
	...
	saveFolder = 'Master Folder'
	scriptName = 'Script Name'
	addFolder = 'scripts, output, assets'


	z = nuke.Panel('New comp from Footage... Created by Luciano Cequinel')
	...
	z.addFilenameSearch('Master Folder', saveFolder)
